...
### GPS + OVERLAP CORRECTION ---
class JointCorrection:
    def __init__(self, verbose=False):
        '''
        Correct an image to GPS point measurements and cinch overlapping regions.
        '''
        # Parameters
    ...
    def __formulate_weighting_matrix__(self, weights='auto'):
        ...
        weights[self.nGPSsamples:self.nGPSsamples+self.nOLAPsamples] = OLAPweight
...
if __name__ == '__main__':
    ...
    correction.correct_images(searchRadius=inps.searchRadius, maxOlap=inps.maxOlap, weights=inps.weights)
