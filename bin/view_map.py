...
from ImageViewing import plot_raster, plot_histogram, image_clip_values, image_stats
...
def createParser():
    ...
    DisplayArgs.add_argument('-d','--downsample-factor', dest='dsFactor', type=float, default=0,
        help='Factor (power of two) by which to downsample the image for display. ([0], 1, 2, ...')
