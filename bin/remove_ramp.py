...
from ImageIO import load_gdal_dataset, confirm_outname_ext, save_gdal_dataset
from ImageMasking import create_mask
from ImageFitting import fit_surface_to_image
...
if __name__ == '__main__':
    ...
    # Fit surface
    ramp, B = fit_surface_to_image(img, mask, inps.degree, dx=dx, dy=dy,
    ...
    outname = confirm_outname_ext(inps.outname, ['tif', 'tiff'],
            verbose=inps.verbose)
    save_gdal_dataset(outname, derampImg, mask=mask, exDS=DS,
            verbose=inps.verbose)
